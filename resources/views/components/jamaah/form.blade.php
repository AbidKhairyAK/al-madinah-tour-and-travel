...
@section('content')
<div id="page-header">
	<h1 class="h3 mb-1 text-gray-800">Form Jamaah</h1>
</div>
	...
	<div class="col-md-8">
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				...
				<form action="{{url('/jamaah')}}">

					<div class="form-group">
						<label class="w-100">
							<b class="d-inline-block mb-2">Nama Jamaah:</b>
					...
					<div class="row">
						<div class="form-group col-md-6">
							<label class="w-100">
								<b class="d-inline-block mb-2">Tanggal Keberangkatan:</b>
								<input type="date" class="form-control">
							</label>
						</div>
						...
						<div class="form-group col-md-6">
							<label class="w-100">
								<b class="d-inline-block mb-2">Tanggal Expairy:</b>
								<input type="date" class="form-control">
							</label>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group col-md-4">
							<label class="w-100">
								<b class="d-inline-block mb-2">Status Pembayaran:</b>
								<select class="form-control">
									<option></option>
									<option>Belum</option>
									<option>DP</option>
						...
						<div class="form-group col-md-4">
							<label class="w-100">
								<b class="d-inline-block mb-2">Status Passport:</b>
								<select class="form-control">
									<option></option>
									<option>Belum</option>
						...
						<div class="form-group col-md-4">
							<label class="w-100">
								<b class="d-inline-block mb-2">Status Suntik:</b>
								<select class="form-control">
									<option></option>
									<option>Belum</option>
									<option>Selesai</option>
					...
					<div class="form-group">
						<label class="w-100">
							<b class="d-inline-block mb-2">Upload Foto:</b>
