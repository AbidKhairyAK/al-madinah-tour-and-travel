...
@section('content')
<div id="page-header">
	<h1 class="h3 mb-1 text-gray-800">Detail Pesan</h1>
</div>
	...
	<div class="col-md-8">
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				...
				<div class="row mb-2">
					<span class="col-md-4 font-weight-bold">Kepada</span>
					<span class="col-md-8">: Hambal bin Hambal</span>
				</div>
				<div class="row mb-2">
					<span class="col-md-4 font-weight-bold">Tanggal</span>
					<span class="col-md-8">: 20 Mei 2019</span>
				</div>
				<div class="row mb-2">
